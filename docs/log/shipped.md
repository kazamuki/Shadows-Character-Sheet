...
| — | Wishes granted (docs) | — | The 27 built wishlist items move, whole, to `log/wishes-granted.md`; `WISHLIST.md` keeps the 10 open ones; INDEX names both homes for a `W` id; close-the-session carries the step · Decision 144 |
