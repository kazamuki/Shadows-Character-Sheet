...
**Updated:** 2026-09-25
**Versions:** app `0.27.1` · game data `0.21` · character schema `0.12` · ruleset **CRB v4 (in progress)**
...
**The 2026-09-24 audit is down to its last session** (`log/2026.md` has
...
shop. The header is two thin rows, its tabs one scrolling line (140). Tests
enforce all of it.
...
|---|---|---|
| **Audit remediation** — `plans/audit-2026-09-remediation.md` | 📋 S1–S5, S6a, S6b ✅ · S6c (the roster) ⏭ · S7 opportunistic | Nobody. S6c starts with a proposal to Ken |
...
**The audit plan's last session; the plan specifies it:**
- **S6c, the roster (R10).** Saved slots keyed by the TAG; Home lists them.
- **`npm run phone-check` passes** (140): run it after touching the header.
...
Oxanium numbers, the first release from the release workflow. 0.27.1 (S6a, rules a tap away, and S6b, the header) is built, not yet released. Next, unblocked: S6c. Ken alone: F9, F12, F13 and F32. The wishlist holds W28 (blocked), W29 (a GM mode),
