...
window.SHADOWS_DATA = {
  ...
  "weaponModGlossary": [
    { "id": "Silencer", "slots": 1, "description": "Grants the Silent tag. Subsonic fire only -- not for shotguns or heavy weapons, and requires subsonic ammunition. Anyone within 6m may make a Combat Sense check to locate the source." },
    { "id": "Laser Sight", "slots": 1, "description": "+1 ACC on aimed shots, stacking with other accuracy bonuses. Green lasers can cause Disoriented on direct unprotected eye contact." },
    { "id": "Holo Sight", "slots": 1, "description": "+1 ACC on aimed shots, stacking with other accuracy bonuses. Does not stack with SMART Targeting. Displays magazine count in the sight picture." },
    { "id": "Scope", "slots": 1, "description": "+2 ACC on aimed shots at Long or Extreme range only; no benefit closer. Does not stack with Holo Sight or Laser Sight. Compatible with rifles and the ADS TC-1 Strix only." },
  ...
  "domains": [
    ...
    { "id": "force", "name": "Force", "glyphs": ["Shockwave", "Gravity", "Barrier", "Telekinesis", "Distortion"],
      "description": "Kinetic and spatial manipulation. Force spells move things -- toward, away, together, apart, or not at all. The Domain of leverage." },
  ...
  "spellcraftRules": {
    ...
    "outcomes": {
      "overflow": "Net Hits exceed TH. The spell works and produces an additional effect: +1x per net Hit above TH, plus +1x per explosion. Known spells define what each x-tier produces; Improvised Overflow is GM-determined.",
  ...
  "spells": [
    ...
    { "id": "dominate-mind", "name": "Dominate Mind", "tier": "superior", "domain": "mind", "glyph": "Compulsion", "tn": 8, "th": 4, "range": "Short", "spellType": "offensive", "damageType": "spirit", "target": "1 person", "effect": "Caster controls the target's action for 1 round", "defending": "WILL Essence", "overflow": { "1x": "Duration extends by [X] round.", "2x+": "Duration extends, a complex or multi-part action can be forced, and the target is Stunned on release." }, "notes": "They know it happened, they remember it happening, and they were present for all of it. This is not a subtle working and it is not forgiven. Sovereign Soul applies.", "flavorLine": "The most direct exercise of will over another mind that Evocation offers." },
