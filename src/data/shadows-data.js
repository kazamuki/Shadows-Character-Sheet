...
window.SHADOWS_DATA = {
  ...
  "milestones": {
    ...
    "majorGeneral": [
      ...
      },
      {
        ...
        "flagged": true,
        "flagNote": "F27: 041 asks for the Cat Like Balance Advantage at Rank 1, but that Advantage was culled from an earlier version (it gave +3 to Athletics or Acrobatics checks for balance) and 043 has no such entry, so the id matched nothing and the Milestone could never be taken. Ken, 2026-09-24: the prerequisite needs removing or replacing. Stub: Time Sense and Danger Sense are still checked; Cat Like Balance is the GM's call, the way every prose prerequisite is (Decision 91).",
        "playerNote": "One of this Milestone's prerequisites names an Advantage that's no longer in the game. Until that's settled, your GM decides whether you meet it.",
        "prerequisites": {
          "majorCount": 1,
          "advantages": {
            "all": [
            ...
            "note": "Cat Like Balance at Rank 1 (no longer in the game)"
          }
        },
  ...
  "equipment": [
    ...
    { "id": "blink-card", "name": "Blink card", "category": "singleUse", "spellName": "Blink", "availability": "Rare", "cost": 150, "consumable": true, "notes": "One crossing." },
    ...
    { "id": "everlight-slip", "name": "Everlight slip", "category": "singleUse", "spellName": "Everlight", "availability": "Common", "cost": 40, "pack": 10, "unit": "slip", "consumable": true, "notes": "Sold in strips of ten." },
    ...
    { "id": "everlight-pendant", "name": "Everlight pendant", "category": "charged", "spellName": "Everlight", "availability": "Common", "cost": 300, "charges": 3, "notes": "The most common inscription in the city." },
    ...
    { "id": "tracer-cord", "name": "Tracer cord", "category": "charged", "spellName": "Tracer", "availability": "Uncommon", "cost": 700, "charges": 3, "notes": "Braided leather. Slip it onto something and follow." },
    ...
    { "id": "sure-grip-wrap", "name": "Sure Grip wrap", "category": "durable", "spellName": "Sure Grip", "availability": "Uncommon", "cost": 800, "charges": 5, "notes": "Fits any weapon grip." },
    ...
    { "id": "blink-boots", "name": "Blink boots", "category": "durable", "spellName": "Blink", "availability": "Rare", "cost": 1400, "charges": 5, "notes": "Click your heels." },
    { "id": "truestrike-sight", "name": "Truestrike sight", "category": "durable", "spellName": "Sure Hand", "availability": "Rare", "cost": 1600, "charges": 5, "notes": "Fixed to a weapon." },
    ...
    { "id": "second-wind-charm", "name": "Second Wind charm", "category": "durable", "spellName": "Second Wind", "availability": "By Practice", "cost": 2200, "charges": 5, "startsEmpty": true, "notes": "Sold empty." },
    { "id": "turning-rune", "name": "Turning rune", "category": "durable", "spellName": "Turning Rune", "availability": "By Practice", "cost": 3000, "charges": 5, "notes": "Armor inlay. Triggers on a hit." },
    { "id": "watchward", "name": "Watchward", "category": "wards", "spellName": "Watchward", "availability": "Uncommon", "cost": 600, "notes": "Silent alert, any distance." },
    { "id": "frost-trap", "name": "Frost Trap", "category": "wards", "spellName": "Frost Trap", "availability": "Rare", "cost": 800 },
    ...
    { "id": "threshold-ward", "name": "Threshold Ward", "category": "wards", "spellName": "Threshold Ward", "availability": "By Practice", "cost": 2400, "notes": "Target type named at inscription." },
    { "id": "stasis-trap", "name": "Stasis Trap", "category": "wards", "spellName": "Stasis Trap", "availability": "By Practice", "cost": 3000 },
    { "id": "spikefield", "name": "Spikefield", "category": "wards", "spell": "spikefield", "spellName": "Spikefield", "availability": "By Practice", "cost": 4500 },
    { "id": "everlight-lamp", "name": "Everlight lamp", "category": "artifacts", "spellName": "Everlight", "availability": "Rare", "cost": 3500, "notes": "Ready every night, forever." },
    { "id": "hearthstone-artifact", "name": "Hearthstone (Artifact)", "category": "artifacts", "spellName": "Hearthstone", "availability": "Rare", "cost": 4000, "notes": "A room that is never cold again." },
    { "id": "watchward-stone", "name": "Watchward stone", "category": "artifacts", "spellName": "Watchward", "availability": "Rare", "cost": 5500, "notes": "Set in a doorframe. Never needs resetting." },
    ...
    { "id": "tracer-ring", "name": "Tracer ring", "category": "artifacts", "spellName": "Tracer", "availability": "By Practice", "cost": 6000, "notes": "Marks one target a day, holds until dawn." },
    ...
    { "id": "grave-iron-blade", "name": "Grave-iron blade", "category": "artifacts", "spellName": "Consecrate", "availability": "By Contract", "cost": null, "costText": "Varies", "notes": "Deals Spirit damage to things that shrug off steel." },
    { "id": "blink-boots-artifact", "name": "Blink boots", "category": "artifacts", "spellName": "Blink", "availability": "By Practice", "cost": 12000, "notes": "Five crossings, recovered by morning." },
    { "id": "ferrymans-coin", "name": "Ferryman's coin", "category": "artifacts", "spell": "tether", "spellName": "Tether", "availability": "By Contract", "cost": 30000, "notes": "One automatic Death check. Recovers after a month." }
  ],
  ...
  /* MAGIC -- merged from the CRB v4 Magic chapter (docs/reference/crb/Magic.md),
     ...
     glyph + TN/TH/range/type/target/effect/defending/overflow/tags); `spellTiers`
     documents the TN/TH per tier; `spellcraftRules` documents the roll, the five
     ...
     Overflow text preserves the WIP's own `[X]` placeholders verbatim -- these
     are unresolved balance magnitudes Scott hasn't set numbers for yet, not a
     transcription gap, and no value here should be invented to replace one. */
  "domains": [
  ...
  "spellcraftRules": {
    ...
    "concentration": "A held spell sets aside dice equal to its Threshold from the Arcanist's pool, unavailable for any Essence roll while held. Concentration held through a Talisman costs 1 die fewer, through an Artifact 2 fewer, to a floor of 1. Ends automatically if the Arcanist falls unconscious.",
  ...
  "enchantmentTimeTable": [
    { "tier": "cantrip", "evocationTH": 1, "enchantmentTH": 3, "enchantmentMinTime": "3 hours", "alchemyTH": 6, "alchemyMinTime": "6 days" },
    { "tier": "standard", "evocationTH": 2, "enchantmentTH": 4, "enchantmentMinTime": "4 hours", "alchemyTH": 7, "alchemyMinTime": "7 days" },
    { "tier": "advanced", "evocationTH": 3, "enchantmentTH": 5, "enchantmentMinTime": "5 hours", "alchemyTH": 8, "alchemyMinTime": "8 days" },
    { "tier": "superior", "evocationTH": 4, "enchantmentTH": 6, "enchantmentMinTime": "6 hours", "alchemyTH": 9, "alchemyMinTime": "9 days" }
  ],
  ...
  "spells": [
    { "id": "dart", "name": "Dart", "tier": "cantrip", "domain": "elements", "glyph": "Fire", "tn": 7, "th": 1, "range": "Short", "spellType": "offensive", "damageType": "elemental", "target": "1 person or object", "effect": "½ SP Damage", "defending": "Dodge", "overflow": { "1x": "Full Spell Power damage.", "2x+": "Full Spell Power damage, and the target is Burning." }, "tags": ["Fire"], "flavorLine": "A focused mote of incendiary energy hurled at a single target. The first spell most Arcanists learn to throw, and the one they keep throwing." },
    { "id": "gust", "name": "Gust", "tier": "cantrip", "domain": "elements", "glyph": "Air", "tn": 7, "th": 1, "range": "Short", "spellType": "utility", "target": "1 person or object", "effect": "Push 1-2m", "defending": "Dodge", "overflow": { "1x": "Push distance increases by [X]m.", "2x+": "Push distance increases by [X]m, and the target is Prone." }, "flavorLine": "A short burst of wind directed at a target or object. No damage unless the environment makes the push dangerous -- which, in NYTE City, it often is." },
    { "id": "kindle", "name": "Kindle", "tier": "cantrip", "domain": "elements", "glyph": "Fire", "tn": 7, "th": 1, "range": "Close", "spellType": "utility", "target": "1 small combustible object", "effect": "Ignites the target", "defending": "None", "overflow": { "1x": "Ignites moderately resistant materials.", "2x+": "Ignites multiple objects at once, or ignition is instantaneous rather than gradual." }, "tags": ["Fire"], "flavorLine": "A focused burst of heat, enough to catch paper, dry cloth, or spilled fuel. What it does to what it touches is a separate matter." },
    { "id": "sparks", "name": "Sparks", "tier": "cantrip", "domain": "elements", "glyph": "Fire", "tn": 7, "th": 1, "range": "Close", "spellType": "offensive", "damageType": "elemental", "target": "1 person, or flammable objects in range", "effect": "1 Damage, and flammables ignite", "defending": "Dodge", "overflow": { "1x": "½ Spell Power damage, or a significantly wider area ignited.", "2x+": "½ Spell Power damage, and the target is Burning." }, "tags": ["Fire"], "flavorLine": "A shower of sparks radiating outward. Enough to startle, not enough to matter unless something else catches." },
    { "id": "tremor", "name": "Tremor", "tier": "cantrip", "domain": "elements", "glyph": "Earth", "tn": 7, "th": 1, "range": "Short", "spellType": "utility", "target": "An area of ground or a single surface", "effect": "Difficult terrain in the affected area for 1 round", "defending": "Scramble", "overflow": { "1x": "Affected area increases by [X]m.", "2x+": "Affected area increases, and targets are Prone." }, "tags": ["AOE"], "flavorLine": "A focused vibration driven into a surface. Enough to startle, unbalance, or dislodge something poorly secured." },
    { "id": "zap", "name": "Zap", "tier": "cantrip", "domain": "elements", "glyph": "Lightning", "tn": 7, "th": 1, "range": "Short", "spellType": "offensive", "damageType": "elemental", "target": "1 person or electronic device", "effect": "½ SP Damage, or shorts simple electronics", "defending": "Dodge", "overflow": { "1x": "Full Spell Power damage.", "2x+": "Full Spell Power damage, and cybernetic targets may be DeSynced." }, "tags": ["EMP"], "flavorLine": "A focused arc of electrical energy. The caster chooses at time of casting whether to hurt someone or break something." },
    { "id": "push", "name": "Push", "tier": "cantrip", "domain": "force", "glyph": "Telekinesis", "tn": 7, "th": 1, "range": "Short", "spellType": "offensive", "damageType": "physical", "target": "1 person or object", "effect": "Shove 2m", "defending": "Dodge", "overflow": { "1x": "Distance increases by [X]m.", "2x+": "Distance increases by [X]m, and the target is Prone." }, "flavorLine": "Raw kinetic force exerted against a person, object, or door. No damage unless they hit something on the way." },
    { "id": "shield", "name": "Shield", "tier": "cantrip", "domain": "force", "glyph": "Barrier", "tn": 7, "th": 1, "range": "Self / Touch", "spellType": "defensive", "target": "Self or 1 ally within reach", "effect": "Absorbs SP damage of any type for 1 round", "defending": "None", "overflow": { "1x": "Absorbed damage increases by [X].", "2x+": "Absorbed damage increases by [X], and the barrier holds an additional round." }, "flavorLine": "A barrier of shaped Aether. The most reliable defensive spell in the Force Domain, and the one most Arcanists master first." },
    { "id": "snatch", "name": "Snatch", "tier": "cantrip", "domain": "force", "glyph": "Telekinesis", "tn": 7, "th": 1, "range": "Short", "spellType": "utility", "target": "1 object of 5 lbs or less", "effect": "Object is pulled to the caster", "defending": "BOD Essence, if held", "overflow": { "1x": "Weight limit increases by [X] lbs.", "2x+": "Weight limit increases, or two objects are pulled at once." }, "flavorLine": "Pulls a small object through the air and into the caster's hand. Useful for weapons, keys, and anything that has ended up somewhere inconvenient." },
    { "id": "crystal-shield", "name": "Crystal Shield", "tier": "cantrip", "domain": "matter", "glyph": "Glass", "tn": 7, "th": 1, "range": "Self / Touch", "spellType": "defensive", "target": "Self or 1 ally within reach", "effect": "Absorbs SP damage of any type for 1 round", "defending": "None", "overflow": { "1x": "Absorbed damage increases by [X].", "2x+": "Absorbed damage increases, and shards deal [X] damage to adjacent attackers when the barrier breaks." }, "flavorLine": "A crystalline barrier, visible and physical, that shatters loudly when it fails." },
    { "id": "thorn-snare", "name": "Thorn Snare", "tier": "cantrip", "domain": "matter", "glyph": "Wood", "tn": 7, "th": 1, "range": "5m radius", "spellType": "utility", "target": "All targets in the area", "effect": "Area becomes Difficult Terrain", "defending": "Scramble", "overflow": { "1x": "Radius increases by [X]m, or duration extends by [X] rounds.", "2x+": "Radius increases, and targets who fail are Restrained." }, "tags": ["AOE"], "flavorLine": "Forces growth from whatever organic material is present -- roots through concrete, vines from a planter, something that was not there a moment ago." },
    { "id": "glimmer", "name": "Glimmer", "tier": "cantrip", "domain": "mind", "glyph": "Illusion", "tn": 7, "th": 1, "range": "Short", "spellType": "utility", "target": "1 person", "effect": "Target's next action takes [X] penalty", "defending": "INT Essence", "overflow": { "1x": "Duration extends by [X] round.", "2x+": "Duration extends, and the target is Disoriented." }, "flavorLine": "A flash of light at the edge of a target's vision -- bright enough to pull focus, brief enough to deny." },
    { "id": "hush", "name": "Hush", "tier": "cantrip", "domain": "mind", "glyph": "Illusion", "tn": 7, "th": 1, "range": "5m radius", "spellType": "utility", "target": "An area", "effect": "[X] bonus to Stealth within the area for 1 round", "defending": "None", "overflow": { "1x": "Radius increases by [X]m, or duration by [X] round.", "2x+": "Both, or silence rather than dampening." }, "tags": ["AOE"], "flavorLine": "Sound dampened to almost nothing. Does not create silence. Creates deniability." },
    { "id": "sense", "name": "Sense", "tier": "cantrip", "domain": "mind", "glyph": "Insight", "tn": 7, "th": 1, "range": "Self", "spellType": "utility", "target": "Self", "effect": "Detect one of: active magic, movement, or hostile intent", "defending": "None", "overflow": { "1x": "Duration or range increases by [X].", "2x+": "Two categories detected at once." }, "flavorLine": "Heightened awareness for the space of a breath." },
    { "id": "true-sight", "name": "True Sight", "tier": "cantrip", "domain": "mind", "glyph": "Insight", "tn": 7, "th": 1, "range": "Self", "spellType": "utility", "target": "Self", "effect": "Reveals hidden creatures, disguises, and invisibility", "defending": "Contested against the concealing effect", "overflow": { "1x": "Range or duration increases by [X].", "2x+": "Both, or extends to an additional sense." }, "flavorLine": "Perception sharpened past whatever is being used to obscure it." },
    { "id": "veil-of-shadows", "name": "Veil of Shadows", "tier": "cantrip", "domain": "mind", "glyph": "Illusion", "tn": 7, "th": 1, "range": "Self / Touch", "spellType": "utility", "target": "Self or 1 ally within reach", "effect": "Target counts as Dark to observers, and gains [X] to Stealth", "defending": "INT Essence to notice", "overflow": { "1x": "Duration extends by [X] round.", "2x+": "Duration extends, or a second target is covered." }, "flavorLine": "Ambient shadow drawn close. Not invisibility -- something better suited to a city with this many corners." },
    { "id": "luck-of-the-bold", "name": "Luck of the Bold", "tier": "cantrip", "domain": "soul", "glyph": "Vitality", "tn": 7, "th": 1, "range": "Self", "spellType": "utility", "target": "Self", "effect": "Bonus to next action equal to net Hits, used within 1 round", "defending": "None", "overflow": { "1x": "Bonus increases by [X].", "2x+": "Bonus increases, and the window extends by one action." }, "flavorLine": "A surge of certainty ahead of a moment that needs it." },
    { "id": "soothe", "name": "Soothe", "tier": "cantrip", "domain": "soul", "glyph": "Vitality", "tn": 7, "th": 1, "range": "Touch", "spellType": "utility", "target": "1 person within reach", "effect": "Negates fear-based penalties", "defending": "WILL Essence, if unwilling", "overflow": { "1x": "Duration extends by [X] round.", "2x+": "Duration extends, and a second target is affected." }, "flavorLine": "Slows the heart rate, clears the adrenaline fog, takes the edge off whatever they just saw." },

    { "id": "aero-scythe", "name": "Aero Scythe", "tier": "standard", "domain": "elements", "glyph": "Air", "tn": 8, "th": 2, "range": "Short", "spellType": "offensive", "damageType": "physical", "target": "1 person or object", "effect": "SP Damage", "defending": "Dodge", "overflow": { "1x": "Damage increases by [X].", "2x+": "Damage increases, and the target is Bleeding." }, "flavorLine": "A blade of compressed air. The trajectory is flat and fast -- nothing visible until it arrives." },
    { "id": "blazing-fury", "name": "Blazing Fury", "tier": "standard", "domain": "elements", "glyph": "Fire", "tn": 8, "th": 2, "range": "5m radius", "spellType": "offensive", "damageType": "elemental", "target": "All targets in the area", "effect": "½ SP Damage each round the spell is held", "defending": "Scramble, each round", "overflow": { "1x": "Radius increases by [X]m.", "2x+": "Radius increases, and targets who fail are Burning." }, "tags": ["AOE", "Fire", "Concentration"], "flavorLine": "The air around a point ignites, engulfing everything in it while the Arcanist holds the shape." },
    { "id": "elemental-battery", "name": "Elemental Battery", "tier": "standard", "domain": "elements", "glyph": ["Fire", "Water", "Lightning"], "tn": 8, "th": 2, "range": "Self", "spellType": "defensive", "target": "Self", "effect": "Absorbs up to SP Elemental damage; discharges on the caster's next attack", "defending": "None", "overflow": { "1x": "Capacity increases by [X].", "2x+": "Capacity increases, and the charge can be released as its own attack rather than riding an existing one." }, "tags": ["Concentration"], "flavorLine": "Elemental force caught and held rather than dispersed. Fire taken is fire returned." },
    { "id": "firebolt", "name": "Firebolt", "tier": "standard", "domain": "elements", "glyph": "Fire", "tn": 8, "th": 2, "range": "Short", "spellType": "offensive", "damageType": "elemental", "target": "1 person or object", "effect": "SP Damage", "defending": "Dodge", "overflow": { "1x": "Damage increases by [X].", "2x+": "Damage increases, and the target is Burning." }, "tags": ["Fire"], "flavorLine": "The workhorse of the Fire Glyph -- straightforward, reliable, and exactly as dangerous as the die pool makes it." },
    { "id": "fog-shroud", "name": "Fog Shroud", "tier": "standard", "domain": "elements", "glyph": "Water", "tn": 8, "th": 2, "range": "10m radius", "spellType": "utility", "target": "An area", "effect": "Area counts as Dark; line of sight across it is broken", "defending": "None", "overflow": { "1x": "Radius increases by [X]m.", "2x+": "Radius increases, and the area counts as Blind rather than Dark." }, "tags": ["AOE", "Concentration"], "flavorLine": "Ambient moisture condensed into a bank of fog thick enough to lose a firefight in." },
    { "id": "frostbite", "name": "Frostbite", "tier": "standard", "domain": "elements", "glyph": "Water", "tn": 8, "th": 2, "range": "Short", "spellType": "offensive", "damageType": "elemental", "target": "1 person", "effect": "½ SP Damage, and the ground beneath them becomes Difficult Terrain", "defending": "Dodge", "overflow": { "1x": "Full Spell Power damage.", "2x+": "Full Spell Power damage, and the target is Restrained." }, "tags": ["Cold"], "flavorLine": "A sharp chill across exposed skin, joints, extremities." },
    { "id": "hydro-push", "name": "Hydro Push", "tier": "standard", "domain": "elements", "glyph": "Water", "tn": 8, "th": 2, "range": "5m cone", "spellType": "utility", "target": "All targets in the cone", "effect": "Push 1-2m; extinguishes small fires", "defending": "Scramble", "overflow": { "1x": "Push distance increases by [X]m.", "2x+": "Push distance increases, and targets are Prone." }, "tags": ["AOE"], "flavorLine": "A directed wave. Good for crowd control, better for making a mess of a room that needed one." },
    { "id": "ice-spear", "name": "Ice Spear", "tier": "standard", "domain": "elements", "glyph": "Water", "tn": 8, "th": 2, "range": "Short", "spellType": "offensive", "damageType": "physical", "target": "1 person or object", "effect": "SP Damage", "defending": "Dodge", "overflow": { "1x": "Damage increases by [X].", "2x+": "Damage increases, and the target is Restrained." }, "tags": ["Cold"], "flavorLine": "A lance of solid ice formed and hurled in one motion. It shatters on impact, which is loud and hard to explain." },
    ...
    { "id": "inferno-burst", "name": "Inferno Burst", "tier": "standard", "domain": "elements", "glyph": "Fire", "tn": 8, "th": 2, "range": "5m radius", "spellType": "offensive", "damageType": "elemental", "target": "All targets in the area", "effect": "SP Damage", "defending": "Scramble", "overflow": { "1x": "Radius increases by [X]m.", "2x+": "Radius increases, and targets who fail are Burning." }, "tags": ["AOE", "Fire"], "flavorLine": "A sudden detonation of heat radiating outward. Fire does not distinguish allies." },
    { "id": "lightning-bolt", "name": "Lightning Bolt", "tier": "standard", "domain": "elements", "glyph": "Lightning", "tn": 8, "th": 2, "range": "Short", "spellType": "offensive", "damageType": "elemental", "target": "1 person or object", "effect": "SP Damage", "defending": "Dodge", "overflow": { "1x": "Damage increases by [X], and the target is Shocked.", "2x+": "Damage increases, the target is Shocked, and cybernetic targets may be DeSynced." }, "tags": ["EMP"], "flavorLine": "A direct bolt of electrical energy. In a city wired end to end, this spell has a way of finding more than it was aimed at." },
    { "id": "lightning-trap", "name": "Lightning Trap", "tier": "standard", "domain": "elements", "glyph": "Lightning", "tn": 8, "th": 2, "range": "Proximity", "spellType": "offensive", "damageType": "elemental", "target": "Designated target type entering range", "effect": "SP Damage on trigger", "defending": "Scramble", "overflow": { "1x": "Damage or area increases at inscription.", "2x+": "Targets who fail are Shocked." }, "tags": ["EMP", "Ench."], "flavorLine": "A discharge waiting in an object for someone to come too close. Has no Evocation form -- the Aether will not hold this shape in open air." },
    { "id": "quake", "name": "Quake", "tier": "standard", "domain": "elements", "glyph": "Earth", "tn": 8, "th": 2, "range": "10m radius", "spellType": "utility", "target": "All targets in the area", "effect": "Targets are Prone; loose structures may collapse", "defending": "Scramble", "overflow": { "1x": "Radius increases by [X]m.", "2x+": "Radius increases, and the broken ground becomes Difficult Terrain." }, "tags": ["AOE"], "flavorLine": "A localized tremor, enough to destabilize structures and put people on the floor." },
    { "id": "shock", "name": "Shock", "tier": "standard", "domain": "elements", "glyph": "Lightning", "tn": 8, "th": 2, "range": "Short", "spellType": "offensive", "damageType": "elemental", "target": "1 person or electronic device", "effect": "SP Damage, or disrupts hardened electronics", "defending": "Dodge", "overflow": { "1x": "Damage increases by [X], and the target is Shocked.", "2x+": "Damage increases, and cybernetic targets may be DeSynced." }, "tags": ["EMP"], "flavorLine": "A sharper, more focused jolt than Zap." },
    { "id": "spark-trap", "name": "Spark Trap", "tier": "standard", "domain": "elements", "glyph": "Lightning", "tn": 8, "th": 2, "range": "Proximity", "spellType": "offensive", "damageType": "elemental", "target": "Designated target type entering range", "effect": "½ SP Damage on trigger", "defending": "Scramble", "overflow": { "1x": "Additional triggers or wider area at inscription.", "2x+": "Targets who fail are Shocked or DeSynced." }, "tags": ["EMP", "Ench."], "flavorLine": "A disorienting discharge set into an object. Has no Evocation form." },
    { "id": "static-burst", "name": "Static Burst", "tier": "standard", "domain": "elements", "glyph": "Lightning", "tn": 8, "th": 2, "range": "5m radius", "spellType": "offensive", "damageType": "elemental", "target": "Electronics and cyberware in the area", "effect": "½ SP Damage to electronics and cyberware", "defending": "TECH Essence", "overflow": { "1x": "Damage increases by [X].", "2x+": "Damage increases, and cybernetic targets are Shocked." }, "tags": ["AOE", "EMP"], "flavorLine": "An electromagnetic pulse radiating outward. Unaugmented targets feel nothing. Shielded housings take nothing either." },
    { "id": "tidal-surge", "name": "Tidal Surge", "tier": "standard", "domain": "elements", "glyph": "Water", "tn": 8, "th": 2, "range": "Short", "spellType": "utility", "target": "All targets in the area", "effect": "Push 1-2m; extinguishes fires and moves loose objects", "defending": "Scramble", "overflow": { "1x": "Push distance or area increases by [X]m.", "2x+": "Both, and targets are Prone." }, "tags": ["AOE"], "flavorLine": "A wave surging outward. No direct damage -- the utility is the point." },
    { "id": "water-breathing", "name": "Water Breathing", "tier": "standard", "domain": "elements", "glyph": "Water", "tn": 8, "th": 2, "range": "Touch", "spellType": "utility", "target": "1 willing person within reach", "effect": "Target breathes underwater for [X] minutes", "defending": "None", "overflow": { "1x": "Duration extends by [X] minutes.", "2x+": "Duration extends, and a second target is affected." }, "flavorLine": "No combat application whatsoever, and occasionally the only thing that matters." },
    { "id": "wind-walker", "name": "Wind Walker", "tier": "standard", "domain": "elements", "glyph": "Air", "tn": 8, "th": 2, "range": "Self", "spellType": "utility", "target": "Self", "effect": "MOB increases by [X]; [X] bonus to Dodge", "defending": "None", "overflow": { "1x": "Duration extends by [X] round.", "2x+": "MOB and Dodge bonuses each increase by [X]." }, "tags": ["Concentration"], "flavorLine": "Moving air wrapped close, lightening the step and sharpening the reaction." },
    { "id": "arc-lash", "name": "Arc Lash", "tier": "standard", "domain": "force", "glyph": "Shockwave", "tn": 8, "th": 2, "range": "Short", "spellType": "offensive", "damageType": "aether", "target": "1 person or object", "effect": "SP Damage", "defending": "Dodge", "overflow": { "1x": "Damage or range increases by [X].", "2x+": "Damage increases, and the target is Disarmed." }, "flavorLine": "A whip of raw Aether. Leaves a mark that does not look like anything conventional made it." },
    { "id": "crush", "name": "Crush", "tier": "standard", "domain": "force", "glyph": "Telekinesis", "tn": 8, "th": 2, "range": "Short", "spellType": "offensive", "damageType": "physical", "target": "1 person", "effect": "SP Damage", "defending": "Dodge", "overflow": { "1x": "Damage or knockback increases by [X].", "2x+": "Damage increases, and the target is Prone." }, "flavorLine": "A nearby object seized and slammed home at speed. What is available shapes what the damage looks like afterward." },
    { "id": "feather-fall", "name": "Feather Fall", "tier": "standard", "domain": "force", "glyph": "Gravity", "tn": 8, "th": 2, "range": "Short", "spellType": "utility", "target": "1 falling person or object", "effect": "Negates falling damage and the Prone that follows", "defending": "None", "overflow": { "1x": "Radius extends to cover additional falling targets.", "2x+": "Radius extends, and duration covers a longer descent." }, "flavorLine": "A descent slowed to survivable speed. Can be cast on someone else mid-fall, which is a specific kind of rescue and requires seeing it happen." },
    { "id": "force-armor", "name": "Force Armor", "tier": "standard", "domain": "force", "glyph": "Barrier", "tn": 8, "th": 2, "range": "Self / Touch", "spellType": "defensive", "target": "Self or 1 ally within reach", "effect": "Absorbs SP + net Hits damage of any type for 1 round", "defending": "None", "overflow": { "1x": "Absorbed damage increases by [X].", "2x+": "Absorbed damage increases, and the barrier holds an additional round." }, "flavorLine": "A layered barrier that scales with the quality of the cast rather than a flat value." },
    { "id": "force-burst", "name": "Force Burst", "tier": "standard", "domain": "force", "glyph": "Shockwave", "tn": 8, "th": 2, "range": "3m radius", "spellType": "offensive", "damageType": "physical", "target": "All targets in the area", "effect": "SP Damage, or push all targets outward", "defending": "Scramble", "overflow": { "1x": "Radius increases by [X]m.", "2x+": "Radius increases, and targets are Prone." }, "tags": ["AOE"], "flavorLine": "Concussive energy radiating outward from the caster." },
    { "id": "kinetic-ward", "name": "Kinetic Ward", "tier": "standard", "domain": "force", "glyph": "Barrier", "tn": 8, "th": 2, "range": "Self / Touch", "spellType": "defensive", "target": "Self or 1 ally within reach", "effect": "Absorbs SP × 2 Physical damage for 1 round", "defending": "None", "overflow": { "1x": "Absorbed damage increases by [X].", "2x+": "Absorbed damage increases, and the ward holds an additional round." }, "flavorLine": "A barrier tuned against impact and nothing else. The Arcanist who knows a firefight is coming reaches for this instead of Shield." },
    { "id": "repel", "name": "Repel", "tier": "standard", "domain": "force", "glyph": "Shockwave", "tn": 8, "th": 2, "range": "5m cone", "spellType": "utility", "target": "All targets in the cone", "effect": "Push 1-2m", "defending": "Scramble", "overflow": { "1x": "Push distance increases by [X]m.", "2x+": "Push distance increases, and targets are Disoriented." }, "tags": ["AOE"], "flavorLine": "A concussive blast that shoves targets back and rattles them badly." },
    { "id": "spatial-warp", "name": "Spatial Warp", "tier": "standard", "domain": "force", "glyph": "Distortion", "tn": 8, "th": 2, "range": "Short", "spellType": "utility", "target": "An area or 1 projectile in flight", "effect": "Alters movement or trajectory; effects negotiated with the GM", "defending": "Dodge, where applicable", "overflow": { "1x": "Affected area or complexity increases.", "2x+": "Both, or duration extends by [X] round." }, "tags": ["Concentration"], "flavorLine": "Local space bent to alter how things move through it. A corridor made longer, a doorway made harder to reach than it looks." },
    { "id": "earthen-shield", "name": "Earthen Shield", "tier": "standard", "domain": "matter", "glyph": "Stone", "tn": 8, "th": 2, "range": "Self / Touch", "spellType": "defensive", "target": "Self or 1 ally within reach", "effect": "Grants Heavy Cover; Integrity [X]", "defending": "None", "overflow": { "1x": "Integrity increases by [X].", "2x+": "Integrity increases, and the barrier covers an additional target." }, "flavorLine": "Hardened earth or concrete pulled up into a wall. Leaves debris behind when it drops." },
    { "id": "facemask", "name": "Facemask", "tier": "standard", "domain": "matter", "glyph": "Flesh", "tn": 8, "th": 2, "range": "Touch", "spellType": "utility", "target": "1 person within reach", "effect": "Target's facial features are reshaped", "defending": "WILL Essence, if unwilling", "overflow": { "1x": "Realism improves, or the change holds without active concentration.", "2x+": "Both, or gestures and vocal patterns are mimicked as well." }, "tags": ["Concentration"], "flavorLine": "Not a disguise in the conventional sense -- the face is genuinely different. Fools cameras, fools people, does not fool gait analysis or a TAG scan." },
    { "id": "iron-lance", "name": "Iron Lance", "tier": "standard", "domain": "matter", "glyph": "Metal", "tn": 8, "th": 2, "range": "Short", "spellType": "offensive", "damageType": "physical", "target": "1 person or object", "effect": "SP Damage, armor piercing", "defending": "Dodge", "overflow": { "1x": "Range or armor penetration increases by [X].", "2x+": "Both, and the target is Bleeding." }, "tags": ["AP"], "flavorLine": "A lance of solid metal formed and driven home." },
    { "id": "mend-flesh", "name": "Mend Flesh", "tier": "standard", "domain": "matter", "glyph": "Flesh", "tn": 8, "th": 2, "range": "Touch", "spellType": "utility", "target": "1 person within reach", "effect": "Restores 1d SP Health Levels", "defending": "WILL Essence, if unwilling", "overflow": { "1x": "Healing increases by [X].", "2x+": "Healing increases, and the target resists damage for [X] rounds." }, "flavorLine": "Tissue knitted back together. Sovereign Soul applies." },
    { "id": "staunch", "name": "Staunch", "tier": "standard", "domain": "matter", "glyph": "Flesh", "tn": 8, "th": 2, "range": "Touch", "spellType": "utility", "target": "1 person within reach", "effect": "Ends Bleeding, Burning, or Shocked", "defending": "WILL Essence, if unwilling", "overflow": { "1x": "A second ongoing condition ends.", "2x+": "All ongoing damage conditions end, and [X] Health Levels are restored." }, "flavorLine": "Seals what is open and smothers what is burning. Handles what the source left behind, not the source. Sovereign Soul applies." },
    { "id": "stone-lash", "name": "Stone Lash", "tier": "standard", "domain": "matter", "glyph": "Stone", "tn": 8, "th": 2, "range": "Short", "spellType": "offensive", "damageType": "physical", "target": "1 person or object", "effect": "SP Damage", "defending": "Dodge", "overflow": { "1x": "Knockback added, or a second minor target struck.", "2x+": "Damage increases, and the target is Prone." }, "flavorLine": "Loose debris animated and whipped outward. Requires debris to be present, which in most of NYTE City is not a constraint." },
    { "id": "stone-skin", "name": "Stone Skin", "tier": "standard", "domain": "matter", "glyph": "Stone", "tn": 8, "th": 2, "range": "Self / Touch", "spellType": "defensive", "target": "Self or 1 ally within reach", "effect": "Absorbs SP damage of any type for 1 round", "defending": "None", "overflow": { "1x": "Absorbed damage increases by [X].", "2x+": "Absorbed damage increases, and the effect holds an additional round." }, "flavorLine": "Skin hardened to the density of stone. Movement is unaffected, which is the part that takes practice." },
    { "id": "stone-spike", "name": "Stone Spike", "tier": "standard", "domain": "matter", "glyph": "Stone", "tn": 8, "th": 2, "range": "Short", "spellType": "offensive", "damageType": "physical", "target": "1 person", "effect": "SP Damage", "defending": "Dodge", "overflow": { "1x": "Damage increases by [X], or knockback added.", "2x+": "Damage increases, and the target is Restrained -- the spike pins rather than pierces clean." }, "flavorLine": "A jagged spike driven up through the ground. Requires the target to be standing on something the spell can work with." },
    { "id": "command", "name": "Command", "tier": "standard", "domain": "mind", "glyph": "Compulsion", "tn": 8, "th": 2, "range": "Short", "spellType": "offensive", "damageType": "spirit", "target": "1 person", "effect": "Target performs one simple action on their next turn", "defending": "WILL Essence", "overflow": { "1x": "A second action is forced, or complexity increases.", "2x+": "Duration extends, and a second target is affected." }, "flavorLine": "Single word, single action, no complexity. The target knows it happened." },
    { "id": "dread-pulse", "name": "Dread Pulse", "tier": "standard", "domain": "mind", "glyph": "Fear", "tn": 8, "th": 2, "range": "5m radius", "spellType": "offensive", "damageType": "spirit", "target": "All targets in the area", "effect": "Targets take [X] penalty while in the area", "defending": "WILL Essence", "overflow": { "1x": "Radius or duration increases by [X].", "2x+": "Radius increases, and targets are Frightened." }, "tags": ["AOE"], "flavorLine": "Psychic terror radiating outward. A wrongness nobody can source and a strong urge to be elsewhere." },
    { "id": "flashbang", "name": "Flashbang", "tier": "standard", "domain": "mind", "glyph": "Fear", "tn": 8, "th": 2, "range": "5m radius", "spellType": "offensive", "target": "An area", "effect": "Area counts as Blind for 1 round", "defending": "Scramble", "overflow": { "1x": "Duration or radius increases by [X].", "2x+": "Duration increases, and targets who fail are Blinded." }, "tags": ["AOE"], "flavorLine": "Functionally identical to the ordnance it is named after, minus the ordnance." },
    { "id": "mind-nudge", "name": "Mind Nudge", "tier": "standard", "domain": "mind", "glyph": "Compulsion", "tn": 8, "th": 2, "range": "Short", "spellType": "offensive", "damageType": "spirit", "target": "1 person", "effect": "Target's next action takes [X] penalty", "defending": "WILL Essence", "overflow": { "1x": "The target's next two actions are affected.", "2x+": "Duration extends, and the target is Disoriented." }, "flavorLine": "A light push against a target's attention. Not control -- just interference." },
    { "id": "rewrite-memory", "name": "Rewrite Memory", "tier": "standard", "domain": "mind", "glyph": "Memory", "tn": 8, "th": 2, "range": "Touch", "spellType": "utility", "damageType": "spirit", "target": "1 person within reach", "effect": "Alters a brief, recent memory", "defending": "WILL Essence", "overflow": { "1x": "Clarity of the implanted memory improves, or the window altered extends.", "2x+": "Both, or corroborating detail is implanted alongside it." }, "flavorLine": "A few minutes rewritten, a face swapped out. It holds under casual recall and frays under pressure. The target almost always knows something happened, even when they cannot say what. Sovereign Soul applies." },
    { "id": "cleanse", "name": "Cleanse", "tier": "standard", "domain": "soul", "glyph": "Vitality", "tn": 8, "th": 2, "range": "Touch", "spellType": "utility", "target": "1 person within reach", "effect": "Removes Bleeding, Blinded, Deafened, Disoriented, Frightened, or Poisoned", "defending": "WILL Essence, if unwilling", "overflow": { "1x": "A second condition is removed.", "2x+": "A second condition is removed, and the target resists reacquiring it this scene." }, "flavorLine": "An affliction drawn out and dispersed. Does not reach what the body has already accepted as permanent. Sovereign Soul applies." },
    ...
    { "id": "frost-wall", "name": "Frost Wall", "tier": "advanced", "domain": "elements", "glyph": "Water", "tn": 8, "th": 3, "range": "Short", "spellType": "defensive", "target": "A line up to 5m long", "effect": "Grants Full Cover; Integrity [X]", "defending": "None", "overflow": { "1x": "Length or Integrity increases by [X].", "2x+": "Both, and the wall shatters outward when destroyed, dealing ½ SP Damage within [X]m." }, "tags": ["Cold"], "flavorLine": "A wall of ice raised along a line. Blocks line of sight and movement until destroyed or melted." },
    ...
    { "id": "aegis", "name": "Aegis", "tier": "advanced", "domain": "force", "glyph": ["Barrier", "Distortion"], "tn": 8, "th": 3, "range": "Self / Touch", "spellType": "defensive", "target": "Self or 1 ally within reach", "effect": "Absorbs SP × 2 damage of any type", "defending": "None", "overflow": { "1x": "Absorbed damage increases by [X].", "2x+": "Absorbed damage increases, and the barrier holds an additional round." }, "tags": ["Concentration"], "flavorLine": "The expensive answer to not knowing what is coming." },
    { "id": "arc-beam", "name": "Arc Beam", "tier": "advanced", "domain": "force", "glyph": "Shockwave", "tn": 8, "th": 3, "range": "Short", "spellType": "offensive", "damageType": "aether", "target": "All targets in a line", "effect": "SP Damage per round held", "defending": "Dodge, each round", "overflow": { "1x": "Beam length or damage per round increases by [X].", "2x+": "Both, and targets are Agonized." }, "tags": ["Concentration"], "flavorLine": "A beam of Aether sustained across rounds for as long as the Arcanist can hold it." },
    { "id": "telekinetic-shove", "name": "Telekinetic Shove", "tier": "advanced", "domain": "force", "glyph": "Telekinesis", "tn": 8, "th": 3, "range": "Short", "spellType": "offensive", "damageType": "physical", "target": "All targets in a line", "effect": "Shove 1-3m; SP Damage on collision", "defending": "Scramble", "overflow": { "1x": "Shove distance increases by [X]m, or additional targets are caught.", "2x+": "Distance increases, and targets are Prone." }, "tags": ["AOE"], "flavorLine": "A wall of kinetic force driven down a line. Anything that hits something solid on the way takes the worse end of it." },
    { "id": "boulder-slam", "name": "Boulder Slam", "tier": "advanced", "domain": "matter", "glyph": "Stone", "tn": 8, "th": 3, "range": "Short", "spellType": "offensive", "damageType": "physical", "target": "1 person", "effect": "SP Damage", "defending": "Dodge", "overflow": { "1x": "Damage or knockback increases by [X].", "2x+": "Damage increases, and the target is Prone and Injured." }, "flavorLine": "A chunk of masonry, a vehicle panel, a section of wall. Requires something suitable to be present." },
    { "id": "knit-bone", "name": "Knit Bone", "tier": "advanced", "domain": "matter", "glyph": "Flesh", "tn": 8, "th": 3, "range": "Touch", "spellType": "utility", "target": "1 person within reach", "effect": "Removes the Injured condition", "defending": "WILL Essence, if unwilling", "overflow": { "1x": "[X] Health Levels are restored alongside the repair.", "2x+": "All Injured conditions are repaired, and [X] Health Levels are restored." }, "flavorLine": "The fracture, the torn nerve, the joint that stopped answering. Takes the place of a week of downtime. Sovereign Soul applies." },
    { "id": "spike-trap", "name": "Spike Trap", "tier": "advanced", "domain": "matter", "glyph": "Stone", "tn": 8, "th": 3, "range": "Proximity", "spellType": "offensive", "damageType": "physical", "target": "Designated target type entering the area", "effect": "SP Damage on trigger", "defending": "Scramble", "overflow": { "1x": "Duration or area increases at inscription.", "2x+": "Targets who fail are Restrained." }, "tags": ["AOE", "Ench."], "flavorLine": "A field of spikes waiting under the floor. Has no Evocation form -- the shaping takes longer than a live cast allows." },
    { "id": "blinding-flash", "name": "Blinding Flash", "tier": "advanced", "domain": "mind", "glyph": "Fear", "tn": 8, "th": 3, "range": "10m radius", "spellType": "offensive", "target": "An area", "effect": "Area counts as Blind for 1 round", "defending": "Scramble", "overflow": { "1x": "Duration or radius increases by [X].", "2x+": "Duration increases, and targets who fail are Blinded and Disoriented." }, "tags": ["AOE"], "flavorLine": "Brighter, broader, and harder to look away from than Flashbang." },
    { "id": "confuse", "name": "Confuse", "tier": "advanced", "domain": "mind", "glyph": "Compulsion", "tn": 8, "th": 3, "range": "Short", "spellType": "offensive", "damageType": "spirit", "target": "1 person", "effect": "Target's perception of their surroundings is distorted for 1-2 rounds", "defending": "WILL Essence", "overflow": { "1x": "Duration extends by [X] round.", "2x+": "Duration extends, the target is Disoriented, and may act against their own interests." }, "flavorLine": "Directions invert, faces shift, the floor stops being reliable. The target acts on what they believe they are seeing." },
    { "id": "ember-sight", "name": "Ember Sight", "tier": "advanced", "domain": "mind", "glyph": "Insight", "tn": 8, "th": 3, "range": "Self", "spellType": "utility", "target": "Self", "effect": "Heat sources resolve through darkness, smoke, and thin barriers", "defending": "None", "overflow": { "1x": "Duration or range increases by [X].", "2x+": "Both, and residual heat can be tracked for [X] minutes after a target has left." }, "tags": ["Concentration"], "flavorLine": "Vision pushed into the infrared. Does not see through walls -- sees through the things people use to hide behind them." },
    { "id": "mirror-image", "name": "Mirror Image", "tier": "advanced", "domain": "mind", "glyph": "Illusion", "tn": 8, "th": 3, "range": "Self", "spellType": "defensive", "target": "Self", "effect": "1-3 illusory duplicates; attacks may strike a duplicate instead", "defending": "INT Essence to identify the original", "overflow": { "1x": "One additional duplicate.", "2x+": "Additional duplicates, and they act independently for [X] rounds." }, "tags": ["Concentration"], "flavorLine": "Duplicates moving in imperfect synchrony with the original. Each one dissipates when hit." },
    { "id": "purge", "name": "Purge", "tier": "advanced", "domain": "soul", "glyph": "Vitality", "tn": 8, "th": 3, "range": "Touch", "spellType": "utility", "target": "1 person within reach", "effect": "Removes Agonized, Paralyzed, Restrained, Stunned, or DeSync", "defending": "WILL Essence, if unwilling", "overflow": { "1x": "A second condition is removed.", "2x+": "All conditions from the Cleanse list are removed as well." }, "flavorLine": "A harder working than Cleanse, reaching what has set deeper. The Aether does not heal these so much as refuse them. Sovereign Soul applies." },
    ...
    { "id": "tether", "name": "Tether", "tier": "advanced", "domain": "soul", "glyph": "Binding", "tn": 8, "th": 3, "range": "Touch", "spellType": "utility", "target": "1 Dying person within reach", "effect": "Next Death check is an automatic success", "defending": "None", "overflow": { "1x": "The automatic success covers the next two Resets.", "2x+": "Two Resets are covered, and the target stabilizes, ending Dying." }, "notes": "Cannot be cast twice on the same target in a scene -- the Aether will hold a thread, but it will not hold it twice.", "flavorLine": "It does not stabilize them and does not wake them. It buys one round. Sovereign Soul applies." },

    { "id": "focused-lightning", "name": "Focused Lightning", "tier": "superior", "domain": "elements", "glyph": "Lightning", "tn": 8, "th": 4, "range": "Short", "spellType": "offensive", "damageType": "elemental", "target": "All targets in a line", "effect": "SP × 2 Damage", "defending": "Scramble", "overflow": { "1x": "Line length extends by [X]m.", "2x+": "Line extends, and all targets hit are Shocked and Stunned." }, "tags": ["AOE"], "flavorLine": "At this scale the spell is pure force rather than arc discharge, and the EMP tag is absent. What it hits, it hits hard." },
    { "id": "frost-spire", "name": "Frost Spire", "tier": "superior", "domain": "elements", "glyph": "Water", "tn": 8, "th": 4, "range": "Short", "spellType": "offensive", "damageType": "physical", "target": "Whatever occupies the target point", "effect": "SP × 2 Damage", "defending": "Scramble to move clear before emergence", "overflow": { "1x": "Damage or spire size increases by [X].", "2x+": "Damage increases, the target is Restrained, and the spire shatters when destroyed for ½ SP within [X]m." }, "tags": ["Cold"], "flavorLine": "A pillar of ice erupting from the ground. It remains afterward as a physical obstacle until destroyed or melted." },
    { "id": "ice-barrage", "name": "Ice Barrage", "tier": "superior", "domain": "elements", "glyph": "Water", "tn": 8, "th": 4, "range": "Short", "spellType": "offensive", "damageType": "physical", "target": "Designated targets, chosen at time of casting", "effect": "SP Damage distributed as the caster chooses", "defending": "Dodge, per target", "overflow": { "1x": "[X] additional projectiles, or damage per projectile increases.", "2x": "Additional projectiles, and targets are Restrained.", "3x": "Additional projectiles, and targets are Restrained and Bleeding." }, "tags": ["Cold"], "flavorLine": "Shards driven simultaneously at everyone the caster has decided is a problem." },
    { "id": "inferno", "name": "Inferno", "tier": "superior", "domain": "elements", "glyph": "Fire", "tn": 8, "th": 4, "range": "5m radius", "spellType": "offensive", "damageType": "elemental", "target": "All targets in the area", "effect": "SP × 2 Damage", "defending": "Scramble", "overflow": { "1x": "Radius increases by [X]m.", "2x+": "Radius increases, and targets who fail are Burning and Agonized." }, "tags": ["AOE", "Fire"], "flavorLine": "A roaring column of flame. Structures burn. Cover burns. The caster should have a plan for what the room looks like afterward." },
    { "id": "aether-lance", "name": "Aether Lance", "tier": "superior", "domain": "force", "glyph": "Shockwave", "tn": 8, "th": 4, "range": "Short", "spellType": "offensive", "damageType": "aether", "target": "1 person or object", "effect": "SP × 2 Damage; ignores armor and barriers", "defending": "Dodge", "overflow": { "1x": "Damage increases by [X].", "2x+": "Damage increases, a second target in line is struck, and both are Agonized." }, "flavorLine": "A spear of pure Aether that passes through barriers as though they were not there. Armor offers no protection either. This is not an impact." },
    { "id": "gravity-crush", "name": "Gravity Crush", "tier": "superior", "domain": "force", "glyph": "Gravity", "tn": 8, "th": 4, "range": "10m radius", "spellType": "offensive", "damageType": "physical", "target": "All targets in the area", "effect": "SP Damage, and targets are driven Prone", "defending": "Scramble", "overflow": { "1x": "Radius or damage increases by [X].", "2x+": "Both, and targets are Restrained and Agonized." }, "tags": ["AOE"], "flavorLine": "Local gravity multiplied. Loose objects become part of the problem." },
    { "id": "phase-shift", "name": "Phase Shift", "tier": "superior", "domain": "force", "glyph": "Distortion", "tn": 8, "th": 4, "range": "Self", "spellType": "utility", "target": "Self", "effect": "Intangible -- passes through solids, immune to physical harm, cannot affect anything material", "defending": "None", "overflow": { "1x": "Duration extends by [X] round.", "2x+": "Duration extends, and one additional person can be carried through." }, "tags": ["Concentration"], "flavorLine": "Briefly outside physical reality. The re-entry is not always clean." },
    { "id": "telekinetic-barrage", "name": "Telekinetic Barrage", "tier": "superior", "domain": "force", "glyph": "Telekinesis", "tn": 8, "th": 4, "range": "Short", "spellType": "offensive", "damageType": "physical", "target": "1 person", "effect": "SP Damage across multiple impacts", "defending": "Dodge", "overflow": { "1x": "[X] additional strikes, or damage per strike increases.", "2x+": "Additional strikes, and the target is Prone and Bleeding." }, "flavorLine": "Debris, furniture, loose fittings -- whatever the room is willing to give up, delivered at speed." },
    { "id": "boulder-crush", "name": "Boulder Crush", "tier": "superior", "domain": "matter", "glyph": "Stone", "tn": 8, "th": 4, "range": "Short", "spellType": "offensive", "damageType": "physical", "target": "1 person", "effect": "SP × 2 Damage", "defending": "Dodge", "overflow": { "1x": "Damage increases by [X].", "2x+": "Damage increases, the target is Prone and Injured, and nearby structure may collapse." }, "flavorLine": "Something genuinely large, lifted and brought down. Leaves the room substantially changed." },
    { "id": "spikefield", "name": "Spikefield", "tier": "superior", "domain": "matter", "glyph": "Stone", "tn": 8, "th": 4, "range": "Proximity", "spellType": "offensive", "damageType": "physical", "target": "Designated target type entering the area", "effect": "SP Damage on trigger", "defending": "Scramble", "overflow": { "1x": "Duration, spike count, or area increases at inscription.", "2x+": "Targets who fail are Restrained and Bleeding." }, "tags": ["AOE", "Ench."], "flavorLine": "A wide array of spikes set into the ground and left to wait. Has no Evocation form." },
    { "id": "blinding-nova", "name": "Blinding Nova", "tier": "superior", "domain": "mind", "glyph": "Fear", "tn": 8, "th": 4, "range": "15m radius", "spellType": "offensive", "target": "An area", "effect": "Area counts as Blind for 1 round", "defending": "Scramble", "overflow": { "1x": "Radius or duration increases by [X].", "2x+": "Both, targets who fail are Blinded, and optical cyberware may be DeSynced." }, "tags": ["AOE"], "flavorLine": "Light intense enough to overwhelm across a wide radius. Anyone with optical augmentation takes it worse." },
    { "id": "dominate-mind", "name": "Dominate Mind", "tier": "superior", "domain": "mind", "glyph": "Compulsion", "tn": 8, "th": 4, "range": "Short", "spellType": "offensive", "damageType": "spirit", "target": "1 person", "effect": "Caster controls the target's action for 1 round", "defending": "WILL Essence", "overflow": { "1x": "Duration extends by [X] round.", "2x+": "Duration extends, a complex or multi-part action can be forced, and the target is Stunned on release." }, "flavorLine": "They know it happened, they remember it happening, and they were present for all of it. This is not a subtle working and it is not forgiven. Sovereign Soul applies." },
    { "id": "return", "name": "Return", "tier": "superior", "domain": "soul", "glyph": "Vitality", "tn": 8, "th": 4, "range": "Touch", "spellType": "utility", "target": "1 person within reach", "effect": "Restores SP × 2 Health Levels and ends Dying", "defending": "WILL Essence, if unwilling", "overflow": { "1x": "[X] additional Health Levels, and one condition is removed.", "2x+": "Full Health Level restoration, and all conditions from the Cleanse list are removed." }, "flavorLine": "The most powerful healing available through Evocation, and still not a resurrection. The target has to be alive when it lands. Sovereign Soul applies." },
    { "id": "vigil", "name": "Vigil", "tier": "superior", "domain": "soul", "glyph": "Binding", "tn": 8, "th": 4, "range": "Touch", "spellType": "utility", "target": "1 body dead within [X] minutes", "effect": "Holds the soul in place and arrests decay", "defending": "None", "overflow": { "1x": "The ward persists [X] minutes after concentration ends.", "2x+": "The ward persists [X] hours after concentration ends, and the body is protected from further harm." }, "tags": ["Concentration"], "flavorLine": "Held, not cast and forgotten. The Arcanist is carrying something, and everything else they do is harder for it. Letting go is always available, and always a decision someone has to say out loud." }
  ],
