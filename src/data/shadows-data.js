...
window.SHADOWS_DATA = {
  ...
  /* MAGIC -- merged from the CRB v4 Magic chapter (docs/reference/crb/Magic.md),
     ...
     reason. The book's Inscribed Spells part isn't merged yet. */
  "domains": [
  ...
  "spells": [
    ...
    { "id": "lightning-trap", "name": "Lightning Trap", "tier": "standard", "domain": "elements", "glyph": "Lightning", "tn": 8, "th": 2, "range": "Proximity", "spellType": "offensive", "damageType": "elemental", "target": "Designated target type entering range", "effect": "SP Damage on trigger", "duration": "Until triggered", "defending": "Scramble", "overflow": { "1x": "Damage or area increases at inscription.", "2x+": "Targets who fail are Shocked." }, "tags": ["EMP", "Ench."], "flavorLine": "A discharge waiting in an object for someone to come too close. Has no Evocation form -- the Aether will not hold this shape in open air." },
    ...
    { "id": "spark-trap", "name": "Spark Trap", "tier": "standard", "domain": "elements", "glyph": "Lightning", "tn": 8, "th": 2, "range": "Proximity", "spellType": "offensive", "damageType": "elemental", "target": "Designated target type entering range", "effect": "½ SP Damage on trigger", "duration": "Until triggered", "defending": "Scramble", "overflow": { "1x": "Additional triggers or wider area at inscription.", "2x+": "Targets who fail are Shocked or DeSynced." }, "tags": ["EMP", "Ench."], "flavorLine": "A disorienting discharge set into an object. Has no Evocation form." },
    ...
    { "id": "spikefield", "name": "Spikefield", "tier": "superior", "domain": "matter", "glyph": "Stone", "tn": 8, "th": 4, "range": "Proximity", "spellType": "offensive", "damageType": "physical", "target": "Designated target type entering the area", "effect": "SP Damage on trigger", "duration": "Until triggered", "defending": "Scramble", "overflow": { "1x": "Duration, spike count, or area increases at inscription.", "2x+": "Targets who fail are Restrained and Bleeding." }, "tags": ["AOE", "Ench."], "flavorLine": "A wide array of spikes set into the ground and left to wait. Has no Evocation form." },
