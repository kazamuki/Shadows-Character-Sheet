...
- **Warding for each kind of magic.** Armor can now take Warding against Elemental, Spirit
  ...
  the three a spell dealt. Self-mending is an upgrade too. Armor that already had Warding
  keeps answering all three.
- **Your Martial Arts styles, on the sheet.** The Skills tab shows the styles you chose, each
  with its bonus, and a skill's description lists every style on offer.
